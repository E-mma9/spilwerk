...
- Telefoon/WhatsApp-nummer is **06-87433537** (+31687433537) — ingevuld in `site/assets/script.js`, `site/index.html` contact-sectie, visitekaartje- en flyer-SVG's en marketing-templates. Er komt mogelijk een eSIM om werk/privé te scheiden; advies is om **06-87433537 zakelijk te houden** (staat al overal gepubliceerd, incl. drukwerk) en het nieuwe nummer privé te gebruiken.
