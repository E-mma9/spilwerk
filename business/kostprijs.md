...
|---|---|---:|
| Domein + DNS | spilwerk.nl bij TransIP/Mijndomein | 0,75 |
| Hosting site | Cloudflare Pages | 0,00 |
| Boekhouding | Moneybird (basic) | 19,00 |
| Beroepsaansprakelijkheid | Schouten Zekerheid IT-zzp pakket | 35,00 |
| E-mail (info@spilwerk.nl) | Google Workspace Business Starter | 7,20 |
| Wachtwoordmanager (zakelijk) | 1Password Business | 7,99 |
| Zakelijke bankrekening | bunq Business / Knab Business | 7,99 |
| Mobiel zakelijk abonnement | Simyo / hollandsnieuwe zakelijk | 15,00 |
| Auto-kilometers (gem. 50 km/wk @ €0,23) | brandstof + onderhoud | 50,00 |
| **Totaal vaste kosten** | | **~143,00** |

Plus eenmalig: KvK-inschrijving €82,25.
...
|---|---:|---:|
| Nieuwe laptop / computer helemaal instellen | €95 | ~2u |
| Backup-setup particulier (cloud + extern + test) | €95 | ~2u |
| SSD inbouwen + Windows overzetten | €85 | ~2u (excl. SSD onderdeel) |
| RAM-upgrade | €55 | ~30 min (excl. RAM onderdeel) |
| Wifi-versterking met accesspoint | €95 | ~1,5u (excl. hardware) |

**Voor zelfstandigen & kleine kantoren:**
...
|---|---:|---:|---:|
| Reistijd (gem. 30 min heen + terug = 1u) | 1u | 1u | 1u |
| Werktijd op locatie | 0,5u | 1u | 2u |
...
### Vaste-prijs klusjes — beste voorspelbaarheid

| Klus | Inkomsten | Tijd-investering | Effectief €/u |
|---|---:|---:|---:|
| Nieuwe laptop instellen | €95 | 2u + 1u reis = 3u | €32/u |
| Backup-setup particulier | €95 | 2u + 1u reis = 3u | €32/u |
...
Particulieren betalen het bedrag inclusief btw. Voor zelfstandige-professionals factureer je excl. btw + 21%.

**KOR** (vrijgesteld onder €20.000 omzet/jaar): waarschijnlijk eerste jaar interessant — je rekent geen 21% btw, particulieren ervaren een lager tarief, eenvoudiger administratie. Nadeel: geen btw-aftrek op zakelijke aankopen. Maandelijks ~€10-20 btw-voordeel mis je dan, dus weegt op tegen administratieve eenvoud.

→ Bij KOR: vermeld op factuur "Btw vrijgesteld op grond van de kleineondernemersregeling — geen btw verschuldigd."

## Wat je elke maand checkt

| Metriek | Doel jaar 1 | Doel jaar 2 |
|---|---:|---:|
| Maandelijkse omzet | €800-1.500 | €2.000-3.500 |
...
Drie kandidaat-pakketten voor later (na 5+ klanten in elk):

- **"Senioren-IT-zorg"** (1×/maand 30 min remote check + onbeperkt bellen): €25/maand
- **"Zelfstandige-onderhoud"** (1×/maand kort onderhoud + voorrang): €60/maand
- **"Nieuw-medewerker-setup"** voor zelfstandigen die af-en-toe iemand aannemen: vast €120

Niet vooraf bedenken — pas vanuit ervaring.
